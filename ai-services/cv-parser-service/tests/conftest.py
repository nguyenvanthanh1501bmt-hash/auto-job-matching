...
def settings(
    ...
    return Settings(
        ...
        CV_ALLOWED_OBJECT_PREFIXES="raw/,cvs/",
        CV_MAX_OBJECT_SIZE_BYTES=10_485_760,
        CV_MAX_EXTRACTED_CHARS=20_000,
        CV_MAX_SECTION_CHARS=5_000,
        ...
        CV_MAX_SKILLS=200,
        CV_MAX_LINKS=30,
        CV_MAX_DOCX_ENTRIES=1_000,
        CV_MAX_DOCX_UNCOMPRESSED_BYTES=52_428_800,
...
def taxonomy(
    ...
    return TaxonomyLoader(
        directory=settings.taxonomy_directory,
...
def generated_fixture_dir(
    ...
    directory = tmp_path / "generated-cvs"
    directory.mkdir(
        parents=True,
        exist_ok=True,
    )
