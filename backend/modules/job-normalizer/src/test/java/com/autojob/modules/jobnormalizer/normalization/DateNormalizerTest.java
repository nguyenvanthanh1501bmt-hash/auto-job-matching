...
class DateNormalizerTest {
    ...
    void shouldNormalizeIsoLocalDateAsPostedAtStartOfDay() {
        Instant result =
                dateNormalizer.normalizePostedAt("2026-07-12");
    ...
    void shouldNormalizeIsoLocalDateAsDeadlineAtEndOfDay() {
        Instant result =
                dateNormalizer.normalizeDeadlineAt("2026-07-12");

        assertThat(result).isEqualTo(
                Instant.parse("2026-07-12T16:59:59.999999999Z")
        );
    }
    ...
    void shouldNormalizeVietnameseDateFormat() {
        Instant result =
                dateNormalizer.normalizePostedAt("12/07/2026");
    ...
    void shouldNormalizeExactUtcInstantWithoutChangingIt() {
        Instant result = dateNormalizer.normalizePostedAt(
                "2026-07-12T03:30:00Z"
        );

        assertThat(result).isEqualTo(
                Instant.parse("2026-07-12T03:30:00Z")
        );
    }
    ...
    void shouldNormalizeLocalDateTimeUsingConfiguredTimezone() {
        ...
        assertThat(result).isEqualTo(
                Instant.parse("2026-07-12T07:30:00Z")
        );
    }
    ...
    void shouldNormalizeVietnameseToday() {
        Instant result =
                dateNormalizer.normalizePostedAt("Hôm nay");
    ...
    void shouldNormalizeEnglishToday() {
        Instant result =
                dateNormalizer.normalizePostedAt("Today");
    ...
    void shouldNormalizeVietnameseYesterday() {
        Instant result =
                dateNormalizer.normalizePostedAt("Hôm qua");

        assertThat(result).isEqualTo(
                Instant.parse("2026-07-10T17:00:00Z")
        );
    }
    ...
    void shouldNormalizeEnglishYesterday() {
        Instant result =
                dateNormalizer.normalizePostedAt("Yesterday");
    ...
    void shouldNormalizeVietnameseDaysAgo() {
        Instant result =
                dateNormalizer.normalizePostedAt("3 ngày trước");
    ...
    void shouldNormalizeEnglishDaysAgo() {
        Instant result =
                dateNormalizer.normalizePostedAt("3 days ago");
    ...
    void shouldUseEndOfDayForRelativeDeadline() {
        Instant result =
                dateNormalizer.normalizeDeadlineAt("Hôm nay");
    ...
    void shouldReturnNullForNullOrBlankInput() {
        assertThat(
                dateNormalizer.normalizePostedAt(null)
        ).isNull();
        ...
        assertThat(
                dateNormalizer.normalizeDeadlineAt(null)
        ).isNull();
    }
}